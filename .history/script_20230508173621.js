...
let dateField=false;
let leaveTypeField= false;
let photoField= false;

const validationCheck = () => {
  if (nameField && noOfDaysField && dateField) {
...
const leaveDate = document.getElementById("startdate");
leaveDate.addEventListener("keyup", (event) => {

...
submitButtonCatch.addEventListener("click",() =>{
    ...
    if(flag) 
    {
        ...
        else
        {
            ...
            row.innerHTML = `<td>${object.name}</td>
                    <td>${object.startdate}</td>
                    <td>${object.days}</td>
                    <td>${object.leaves}</td>
                    <td><img id="img" src=${object.photo} alt=""></td>
                    <td><a href="index.html" id="edit">Edit</a> <input type='button' value= 'Reject' name=${object.id} id="reject"/></td>`;
